#!/usr/bin/env python3
"""
Parse Mastersportal Engineering & Technology listings and bulk-insert into Supabase.
Reuses the same parsing approach as insert_cs_it_pages_6_95.py.
Deduplicates against existing fingerprints in DB.
"""
...
SOURCE_URL = "https://www.mastersportal.eu/disciplines/52/engineering-technology.html"
CATEGORY = "engineering-technology"
INPUT_FILE = os.path.join(os.path.dirname(__file__), "..", "Documents",
                          "2.1k Master's degrees in Engineering and Tech.txt")
...
FIELD_KEYWORDS = [
    ("Mechanical Engineering", ["mechanical","mechatronic","manufacturing","automotive","aerospace","aeronaut","aviation"]),
    ("Electrical Engineering", ["electrical","electronic","power engineering","circuit","semiconductor"]),
    ("Civil Engineering", ["civil","structural","construction","geotech","bridge","transport"]),
    ("Chemical Engineering", ["chemical","process engineering","petroleum","biochem"]),
    ("Energy", ["energy","renewable","solar","wind","nuclear","hydro","geothermal"]),
    ("Environmental Engineering", ["environment","sustainab","ecolog","water","climate","green"]),
    ("Materials Science", ["material","nanotech","polymer","composite","metallurg"]),
    ("Biomedical Engineering", ["biomedical","medical engineer","bioengineer","biotech","health technology"]),
    ("Industrial Engineering", ["industrial","logistics","supply chain","operations","production"]),
    ("Robotics", ["robotic","automation","mechatron","control system"]),
    ("Computer Engineering", ["computer engineer","embedded","fpga","microelectron"]),
    ("Telecommunications", ["telecommunication","communication","network","wireless","5g"]),
    ("Artificial Intelligence", ["artificial intelligence","ai ","machine learning","deep learning"]),
    ("Quantum Engineering", ["quantum"]),
    ("Photonics", ["photonic","optic","laser"]),
    ("Marine Engineering", ["marine","maritime","ocean","naval","ship"]),
    ("Aerospace", ["aerospace","aeronautic","aviation","space"]),
    ("Engineering Management", ["engineering management","project management","management of technology"]),
    ("Data Engineering", ["data engineer","data science","big data","analytics"]),
    ("Geomatics", ["geomatic","geoinform","remote sensing","gis"]),
]
...
def main():
    ...
    print(f"Engineering programs in DB: {n_cat}")
