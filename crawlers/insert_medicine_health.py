#!/usr/bin/env python3
"""
Parse Mastersportal Medicine & Health listings and bulk-insert.

The source file is gitignored and expected to exist locally at:
  Documents/898 Master's degrees in Medicine & Health.txt

Run examples:
  python crawlers/insert_medicine health_management.py --dry-run --limit 20
  python crawlers/insert_medicine health_management.py --limit 100
  python crawlers/insert_medicine health_management.py --country Germany --dry-run
"""
import argparse
import hashlib
import os
...
SOURCE_URL = "https://www.mastersportal.eu/disciplines/24/medicine health-management.html"
CATEGORY = "medicine health"
INPUT_FILE = os.path.join(
    os.path.dirname(__file__),
    "..",
    "Documents",
    "898 Master's degrees in Medicine & Health.txt",
)
...
FIELD_KEYWORDS = [
    ("Business Administration", ["medicine health administration", "mba", "executive medicine health"]),
    ...
    ("International Business", ["international medicine health", "global medicine health", "trade", "export"]),
    ("Entrepreneurship", ["entrepreneur", "startup", "venture", "innovation"]),
    ("Economics", ["economics", "econometric", "economic policy", "macroeconomic"]),
    ("Business Analytics", ["medicine health analytics", "data analytics", "medicine health intelligence", "analytics"]),
    ...
    ("Digital Business", ["digital medicine health", "e-commerce", "digital transformation", "fintech"]),
]
...
def main():
    ...
    with CrawlerRun("program_ingester_medicine health", params=params) as run:
