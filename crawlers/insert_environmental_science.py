#!/usr/bin/env python3
"""
Parse Mastersportal Environmental Science listings and bulk-insert.

The source file is gitignored and expected to exist locally at:
  Documents/1.2k Master's degrees in Environmental Science.txt

Run examples:
  python crawlers/insert_environmental science_management.py --dry-run --limit 20
  python crawlers/insert_environmental science_management.py --limit 100
  python crawlers/insert_environmental science_management.py --country Germany --dry-run
"""
import argparse
import hashlib
import os
...
SOURCE_URL = "https://www.mastersportal.eu/disciplines/24/environmental science-management.html"
CATEGORY = "environmental science"
INPUT_FILE = os.path.join(
    os.path.dirname(__file__),
    "..",
    "Documents",
    "1.2k Master's degrees in Environmental Science.txt",
)
...
FIELD_KEYWORDS = [
    ("Business Administration", ["environmental science administration", "mba", "executive environmental science"]),
    ...
    ("International Business", ["international environmental science", "global environmental science", "trade", "export"]),
    ("Entrepreneurship", ["entrepreneur", "startup", "venture", "innovation"]),
    ("Economics", ["economics", "econometric", "economic policy", "macroeconomic"]),
    ("Business Analytics", ["environmental science analytics", "data analytics", "environmental science intelligence", "analytics"]),
    ...
    ("Digital Business", ["digital environmental science", "e-commerce", "digital transformation", "fintech"]),
]
...
def main():
    ...
    with CrawlerRun("program_ingester_environmental science", params=params) as run:
